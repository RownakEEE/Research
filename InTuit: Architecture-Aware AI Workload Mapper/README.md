...
`Python` `NumPy` `AI Workload Mapping` `CNN Inference` `Performance Modeling`  
`Mapping & Scheduling` `Memory Modeling` `Design-Space Exploration` `Hardware–Software Co-design`
...
The mapping algorithms, workload models, profiling tools, and evaluation framework are maintained in the project repository.
