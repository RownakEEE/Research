...
| | Publication | Link |
|---|---|---|
| **Paper 1** | Messaging-based Adaptive Vector Computing (MAVeC) Accelerator for AI Workloads | [**Paper ↗**](https://arxiv.org/pdf/2410.09961) |
| **Paper 2** | Implications of Memory Embedding and Hierarchy on the Performance of MAVeC AI Accelerators | [**Paper ↗**](https://doi.org/10.1016/j.memori.2025.100131) |
| **Paper 3** | Accelerating PageRank Algorithmic Tasks with a New Programmable Hardware Architecture | [**Paper ↗**](https://doi.org/10.1109/ICRC64395.2024.10937012) |

## Code

The research implementation, mapping tools, performance models, and evaluation framework are available in the project repository.
